...
#    file_FundPricing='Pricing_Fund_analysis_JunAug_step1.xlsx'
    file_FundPricing='Pricing_Fund_analysis_JunAug_stats_greater5_1.xlsx'
    dfAnly=pd.ExcelFile(path1+file_FundPricing,index_col=None,datetime_format='hh:mm:ss')
    ...
    Write_excel(All_Vol_Fund,"Fund_volume_Pricing_JunAug_weekMore")
    #####
