...
if __name__ == "__main__":
    ...
    os.chdir(path1)
    file_Clientpricing='Client_Fund_Pricing_JunAug18_weekmore.xlsx'
    #file_ClientMTMI='Client_Fund_MTMI_JunAug18_weekmore.xlsx'
    dfAnly=pd.ExcelFile(path1+file_ClientMTMI,index_col=None,datetime_format='hh:mm:ss')
    ...
    df.loc[last_row+1]=['000', '16:00:00','16:00:00','16:00:00','16:00:00','16:00:00','16:00:00','16:00:00','16:00:00','16:00:00','16:00:00','16:00:00','16:00:00' ]
    df.loc[last_row+2]=['000', '19:00:00','19:00:00','19:00:00','19:00:00','1900:00','19:00:00','19:00:00','19:00:00','19:00:00','19:00:00','19:00:00','19:00:00' ]
    ...
    Write_excel(All_Vol_Fund,"Client_volume_Pricing_JunAug_weekMore")
    #####
