...
if __name__ == "__main__":
   ...
   # path2='H:\\Downloads\\NDSData\\Step_1\\'
    ...
    #file_FundMTMI='MTMI_Fund_analysis_JunAug.xlsx'
   # file_FundPricing='Pricing_Fund_analysis_JunAug_stats_greater5.xlsx'
    file_FundPricingless='Pricing_Fund_analysis_JunAug_stats_less5.xlsx'
    #file_FundPricing='Pricing_Fund_analysis_JunAug_step1.xlsx'
   # sheet1='less_5 Pred Time Analysis'
   # df_Anly=read_exl_file(path1+ file_FundPricingless,sheet1)
    dfAnly=pd.ExcelFile(path1+file_FundPricingless,index_col=None )
    ...
    df.loc[last_row+1]=['000','000','16:00:00', 0,0,'16:00:00','16:00:00']
    df.loc[last_row+2]=['000','000','19:00:00',0,0,'19:00:00','19:00:00']
    ...
    Write_excel(All_Vol_Fund,"Fund_volume_Pricing_JunAug18_weekless")
    #####
