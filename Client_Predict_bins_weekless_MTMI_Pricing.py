...
if __name__ == "__main__":
    ...
    os.chdir(path1)
    #file_Clientpricing='Client_Fund_Pricing_JunAug18_weekless.xlsx'
    file_ClientMTMI='Client_Fund_MTMI_JunAug18_weekless.xlsx'
   
    dfAnly2=pd.ExcelFile(path1+file_ClientMTMI,index_col=None,datetime_format='hh:mm:ss')
    dfAnly=pd.read_excel(dfAnly2,index_col=None)
    colnm=dfAnly.columns
    df=dfAnly
    last_row=df.shape[0] 
    '''Adding extra time for smooth Time series data,resample will start  from 16:00:00 to 19:00:00'''
    df.loc[last_row+1]=['000', '16:00:00','16:00:00','16:00:00'] 
    df.loc[last_row+2]=['000', '19:00:00','19:00:00','19:00:00'] 
    ...
    Write_excel(All_Vol_Fund,"Client_volume_MTMI_JunAug_weekless")
    #####
